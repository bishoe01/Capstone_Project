...
function MainPage({ props }) {
  ...
  const { user, locationURL } = useRoomContext();
        ...
        <div className='flex border-primary h-[400px] rounded-xl mt-4 relative z-0 px-16 justify-between items-center'>
          ...
          <div className='text-primary flex justify-center items-start flex-col w-[600px] gap-4'>
            ...
            <div className='flex justify-center items-center gap-4 text-xl'>
              <button
                onClick={() => navigate(`/reserve/${locationURL[user?.university]}`)}
                className='p-4 px-6 mt-5 border-[4px] border-emphasize rounded-full text-emphasize'>예약하러 가기</button>
              <button
