...
function ReserveState({ state, location, time, name, headCount, date }) {
  return (
    <>
            ...
            <ul className='flex flex-col justify-around items-center h-full px-4 py-3 border-r border-dotted border-sub'>
              <li className='w-full'>
                <div className='flex flex-row justify-start items-center'>
                  <img src='icons/location.png' alt='' className='w-6 h-6 mr-2' />
                  <span className='text-primary align-middle leading-normal'>{location}</span>
                </div>
              </li>
              <li className='w-full'>
                <div className='flex flex-row justify-start items-center py-2'>
                  <img src='icons/clock.png' alt='' className='w-6 h-6 mr-2' />
                  <span className='text-primary align-middle'>{time}</span>
                </div>
              </li>
              <li className='w-full'>
                <div className='flex flex-row justify-start items-center'>
                  <img src='icons/sharp.png' alt='' className='w-6 h-6 mr-2' />
          ...
          <div className='flex flex-row basis-1/2 py-1 px-[2%]'>
            <div className='flex flex-col justify-around basis-3/4 h-full'>
              ...
              <div className='flex flex-col'>
                ...
                <span className='text-primary pl-4'>{name}</span>
              </div>
              <div className='flex flex-col'>
            ...
            <div className='flex flex-col justify-around items-center basis-1/4'>
              ...
              <CommonBtn width={20} height={7} color={'textgray'} bgColor={'accent'} text={'퇴실'} />
            </div>
          </div>
        </div>
      </div>
